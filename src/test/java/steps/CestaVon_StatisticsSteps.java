...
public class CestaVon_StatisticsSteps extends TestStepActions {
    ...
    public void saveListOfOmamaMenorAndSupervizor() {
        ...
        int list_index = 10;
        int count_users = 1;
        indexparameters.put(1, "Všetko"); indexparameters.put(2, "Omama");
        indexparameters.put(5, "aktívna"); indexparameters.put(3, "Mentor");
        indexparameters.put(9, "neaktívna"); indexparameters.put(4, "Supervízor");
        indexparameters.put(7, "neaktívna"); indexparameters.put(6, "aktívna");
    ...
    public void veirfyDetailsAboutOmamasMentorsAndSupervizors() {
        indexparameters.put(40, "Omamy"); integerparameters.put(10, 4);
        indexparameters.put(41, "Mentorky"); integerparameters.put(11, 2);
        indexparameters.put(42, "Supervízori"); integerparameters.put(12, 3);
        String list = "";
    ...
    public void saveListOfClients() {
        indexparameters.put(44, "aktívny"); indexparameters.put(45, "neaktívny");
        int list_index = 19;
        String NextPageEnabled = "false"; String inactiveUsersList = "", activeUserList = "", allUserList = "";
...
//            List<WebElement> user_last_name = driver.findElements(page.getListActiveInactiveClientsLocator(indexparameters.get(44), indexparameters.get(45),3));
//            List<WebElement> user_first_name = driver.findElements(page.getListActiveInactiveClientsLocator(indexparameters.get(44), indexparameters.get(45),2));
            ...
            clickElementUsingJavascript(driver, NextPageButton.getElement(driver), NextPageButton.getDescription());
            sleep(1000);
            ReportExtender.logInfo(NextPageEnabled);
        }
    ReportExtender.logInfo(indexparameters.get(list_index));
    ReportExtender.logInfo(indexparameters.get(list_index+1));
    ReportExtender.logInfo(indexparameters.get(list_index+2));
    }
