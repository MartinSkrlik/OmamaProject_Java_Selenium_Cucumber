...
Feature: CestaVon - Browsing Users
  ...
  @Positive
  Scenario Outline: CestaVon - Login with valid credentials and filter users
    ...
    And     Set Search Field "<SEARCH_FIELD>" to "<SEARCH_TEXT>"
    ...
    Examples:
      ...
      | Chrome  | Cestavon | admin    | Testcestavon1 | 1111    | Používatelia | Omama       | Meno         | om          |